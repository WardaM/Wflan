angular.module('starter', ['ionic', 'starter.controllers', 'starter.services']) // Création d'un module(Premier paramettre : Nom du module; Second paramettre : Les module externe qui à besoin pour fonctionner [equivalent du require en php])
...
.config(function($stateProvider, $urlRouterProvider) { // Lancement de la fonction config qui definie la configuration du site (Les route, la route appellé au lancement du site, ...)
